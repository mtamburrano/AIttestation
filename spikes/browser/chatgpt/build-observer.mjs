...
async function observerBundle() {
  ...
  const bundle = '// Generated by build-observer.mjs. Edit transport/*.mjs or recipient/chatgpt-route.mjs, then rebuild.\n(() => {\n"use strict";\n' + modules.join('\n') + '\n})();\n';
  return bundle.replace('__ATTESTAMP_OBSERVER_BUILD__', createHash('sha256').update(bundle).digest('hex'));
}
