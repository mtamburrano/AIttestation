...
export class RecordingSession {
  ...
  constructor(directory, {
    ...
    if (!directory || !fastTrust || fastTrust.profile !== FAST_CONFIRM_PROFILE || typeof collectFast !== 'function'
        || (!vault && (!Buffer.isBuffer(vaultKey) || vaultKey.length !== 32))) {
      throw Error('Recording session requires fast-confirmation trust and explicit vault custody');
    }
